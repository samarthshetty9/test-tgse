    ...
    <section className="bg-gradient-hero py-20 text-center text-white">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <button className="bg-white text-[#721D32] font-semibold py-3 px-8 rounded shadow-sm hover:bg-gray-100 hover:-translate-y-0.5 transition-all duration-300">
            Start Application
          </button>
          
          {/* Secondary Button: Transparent with White Border */}
          <button className="bg-transparent border border-white text-white font-semibold py-3 px-8 rounded hover:bg-white/10 transition-all duration-300">
            Contact Us
          </button>
