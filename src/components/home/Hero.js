  ...
  return (
    <section className="bg-gradient-hero relative min-h-[650px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
        ...
        >
          <Link href="/admissions" className="btn-shine bg-white text-[#5D1528] font-bold py-3.5 px-8 rounded flex items-center gap-2 hover:bg-gray-100 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] hover:-translate-y-1">
            Apply Now
          ...
          <Link href="/contact" className="bg-white/10 backdrop-blur-sm border border-white/30 text-white font-bold py-3.5 px-8 rounded hover:bg-white/20 transition-all duration-300 hover:-translate-y-1">
            Book a Visit
          </Link>
        </div>
      </div>
