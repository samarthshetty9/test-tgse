    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow pt-20">
                ...
                >
                    <Link href="/contact" className="bg-[#F3D03E] text-[#5D1528] font-bold py-3 px-8 rounded shadow-lg hover:bg-white hover:scale-105 transition-all duration-300 flex items-center gap-2">
